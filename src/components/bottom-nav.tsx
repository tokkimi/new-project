...
import { ShoppingBag, House, Camera, ClipboardCheck, UserRound } from "lucide-react";
...
export function BottomNav() {
  ...
  const TABS = [
    { href: "/app/today", label: t("today"), icon: House },
    ...
    { href: "/app/profile", label: t("profile"), icon: UserRound },
  ];
