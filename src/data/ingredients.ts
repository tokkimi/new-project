...
export const INGREDIENTS: Ingredient[] = [
  { id: "retinol", aliases: ["retinol", "retinal", "tretinoin", "adapalene", "레티놀", "레티날", "아다팔렌"], timePref: "pm", layerWeight: 40 },
  { id: "vitamin_c", aliases: ["ascorbic acid", "vitamin c", "l-ascorbic acid", "아스코빅애씨드", "아스코르브산", "아스코르빈산", "비타민c"], timePref: "am", layerWeight: 20 },
  { id: "niacinamide", aliases: ["vitamin b3", "nicotinamide", "niacinamide", "나이아신아마이드", "니아신아마이드"], timePref: "both", layerWeight: 25 },
  { id: "aha", aliases: ["glycolic acid", "lactic acid", "mandelic acid", "글라이콜릭애씨드", "글리콜산", "락틱애씨드", "젖산", "만델릭애씨드"], timePref: "pm", layerWeight: 30 },
  { id: "bha", aliases: ["salicylic acid", "살리실릭애씨드", "살리실산"], timePref: "pm", layerWeight: 30 },
  { id: "benzoyl_peroxide", aliases: ["benzoyl peroxide", "bpo", "벤조일퍼옥사이드", "과산화벤조일"], timePref: "both", layerWeight: 35 },
  { id: "vitamin_e", aliases: ["tocopherol", "토코페롤"], timePref: "both", layerWeight: 22 },
  { id: "peptides", aliases: ["copper peptides", "ghk-cu", "peptides", "펩타이드", "카퍼펩타이드"], timePref: "both", layerWeight: 45 },
  { id: "hyaluronic_acid", aliases: ["hyaluronic acid", "sodium hyaluronate", "하이알루로닉애씨드", "소듐하이알루로네이트", "히알루론산"], timePref: "both", layerWeight: 15 },
